...
def main() -> None:
    ...
    info.add_argument("--order-type", default="accQuant", help="UI: marketSum, accAmount, up, down, accQuant; sales/operatingProfit returned 500 on 2026-09-07")
    ...
    stocks.add_argument("--order-type", default="accQuant", help="UI: marketSum, accAmount, up, down, accQuant; sales/operatingProfit returned 500 on 2026-09-07")
