...
2026-09-07 후속 검증에서 미국 섹터 v2의 `changeRate`, `marketCap`, `period=daily&size=2`는 서버 cursor를 그대로 전달한 다음 요청도 200이었습니다. 첫·다음 섹터 코드의 비중복과 cursor 전진을 확인했으며 마지막 페이지와 모든 기간 조합은 미검증입니다. 테마 없는 주목 ETF의 500 등 [실패 조건과 대안](known-limitations.md)은 별도로 유지합니다.
