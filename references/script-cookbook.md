...
- `scripts/crypto.py`: 업비트/빗썸 랭킹, 주요 코인, 폴링 가격, 분봉 캔들, 코인 뉴스/프로필, 카테고리 랭킹, AI 브리핑 조회.
...
- `scripts/notices.py`: stockSecurity v1 서비스 공지 목록/상세/배너 조회.
...
python3 scripts/crypto.py coinmacro-news
