...
2026-09-16 후속 범위는 [페이지·페이징 점검표](page-audit-2026-09-16.md)에 추가했습니다. 새 목록·세션·가격·공모주·리서치 계약의 성공 표본은 아래 기존 실패 조건을 해제하지 않습니다. 새 종목 profile은 공통 차단으로 요청 전 거부되어 미지원이며, NXT 원시 차트·일부 외부/내부 UI 분기는 미검증 상태를 유지합니다.
