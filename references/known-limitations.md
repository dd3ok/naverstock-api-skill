...
2026-09-16 후속 점검에서 확인한 새 목록·세션·가격·공모주·리서치 계약의 성공 표본은 아래 기존 실패 조건을 해제하지 않습니다. 모든 상품·기간·필터 조합과 전체 이력 종료는 검증하지 않았습니다. 새 종목 profile은 공통 차단으로 요청 전 거부되어 미지원이며, NXT 원시 차트·일부 외부/내부 UI 분기는 미검증 상태를 유지합니다.
