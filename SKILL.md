...
스크립트별 상세 역할과 자주 쓰는 명령은 [references/script-cookbook.md](references/script-cookbook.md)를 읽고, 전체 endpoint 목록은 [references/api-catalog.md](references/api-catalog.md)를 읽습니다. 옵션은 `python3 scripts/<name>.py --help`로 확인합니다.
